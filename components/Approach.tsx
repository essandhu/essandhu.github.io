  ...
  return (
    <section className="w-full py-20" id="approach">
      <h1 className="heading">
        Design <span className="text-purple">Philosophy</span>
      </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          title="Planning is Everything"
          icon={<AceternityIcon order="Phase 1" />}
          description="Spending time on the design can pay dividends during development. I frequently use tools such as Figma or Lucidchart to create wireframes and mockups."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Quality software should be easy to both use and maintain. Documentation tools such as Swagger for API or Notion for general use-cases are invaluable. Unit tests and integration tests follow every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="Deployment is just the beginning. Monitoring user metrics and performance with SaaS such as Google Analytics and Sentry keeps apps practical and functional."
        >
          <CanvasRevealEffect
            animationSpeed={3}
